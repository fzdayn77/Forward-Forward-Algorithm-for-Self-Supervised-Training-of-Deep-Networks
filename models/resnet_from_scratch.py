#
# This ResNet source code is inspired from :
# https://towardsdev.com/implement-resnet-with-pytorch-a9fb40a77448
#
# ResNet official paper : https://arxiv.org/pdf/1512.03385.pdf
#
...
class ResBlock(nn.Module):
    """
    Implementation of the residual block which helps the nework skip
    some layers in order to avoid the vanishing gradient problem
    """
...
class ResNet(nn.Module):
    """
    Implementation of the whole ResNet including layer0 and final layer
    """
